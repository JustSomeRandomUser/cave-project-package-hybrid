		...
		public class KinectController : MonoBehaviour
		{
			...
			private void Start()
			{
				...
				if (kinectSensor != null)
				{
					...
					faceTracker = new FaceTracker(kinectSensor, FaceTracker.AllFaceFrameFeatures);
				}
			...
			public UnityEngine.Quaternion GetHeadRotation()
			{
				if(centerBodyIndex == -1)
					return Quaternion.identity;

				Windows.Kinect.Vector4 q = faceTracker.GetResults(centerBodyIndex).FaceRotationQuaternion;
